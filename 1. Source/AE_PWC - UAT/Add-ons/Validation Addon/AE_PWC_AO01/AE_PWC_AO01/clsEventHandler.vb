                                ...
                                Try
                                    ...
                                    If oForm.Title = "Purchase Request - Draft [Approved]" Then
                                        If String.IsNullOrEmpty(oForm.Items.Item("U_AB_POCREATOR").Specific.string) Then
                                            p_oSBOApplication.StatusBar.SetText("Purchasing Unit should not be Empty .............!", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                                            BubbleEvent = False
                                            Exit Try
                                        Else
                                    ...
                                    Else
                                        ...
                                        sSQL = "SELECT T0.[U_ApprGridCode] FROM [dbo].[@AB_APPROVALMATRIX]  T0 WHERE T0.[U_ApprDept]  = '" & sPurchasingDepartment & "' and T0.[U_DocType]  = 'PR' and isnull(T0.[U_PRFROM],0)  <= " & dAmount & " and  isnull(T0.[U_PRTO],0) >= " & dAmount & ""
                                ...
                                Try
                                    ...
                                    If Left(oMatrix.Columns.Item("V_0").Cells.Item(1).Specific.String, 14) = "Purchase Order" Then
                                        If oForm.Items.Item("28").Specific.value = "N" Then
                                            ...
                                            sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Closed' where Status = 'Pending'" & _
                                             " and draftkey = '" & sDraftKey & "' and DocType = 'PO'"
                                            ...
                                            sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Open', [EmailBody] = '" & Replace(sBody, "'", "''") & "', [EmailSub] = '" & sEmailSubject & "' where seq = " & _
                                               "(select top (1) seq  from " & p_sHoldingEntity & " ..[AB_EmailStatus] where draftkey = '" & sDraftKey & "' and DocType = 'PO' order by cast(Seq as integer) Desc)  and draftkey = '" & sDraftKey & "' and DocType = 'PO'"
                                        ...
                                        ElseIf oForm.Items.Item("28").Specific.value = "Y" Then
                                            ...
                                            sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Open' where seq = " & _
                                                "(select top (1) seq + 1 from " & p_sHoldingEntity & " ..[AB_EmailStatus] where [sUser] like '" & sUser & "' and draftkey = '" & sDraftKey & "' and DocType = 'PO')  and draftkey = '" & sDraftKey & "' and DocType = 'PO'"
                                    ...
                                    ElseIf Left(oMatrix.Columns.Item("V_0").Cells.Item(1).Specific.String, 16) = "Purchase Request" Then
                                        If oForm.Items.Item("28").Specific.value = "Y" Then
                                            ...
                                            sDraftKey = oForm.Items.Item("42").Specific.String
                                            sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Open' where seq = " & _
                                                "(select top (1) seq + 1 from " & p_sHoldingEntity & " ..[AB_EmailStatus] where [sUser] like '" & sUser & "' and draftkey = '" & sDraftKey & "' and DocType = 'PR') and  draftkey = '" & sDraftKey & "' and DocType = 'PR'"
                                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Update Next level " & sQuery, sFuncName)
                                            orset.DoQuery(sQuery)
                                        ElseIf oForm.Items.Item("28").Specific.value = "N" Then
                                            ...
                                            sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Closed' where Status = 'Pending'" & _
                                             " and draftkey = '" & sDraftKey & "' and DocType = 'PR'"
                                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Changing Status to Closed " & sQuery, sFuncName)
                                            orset.DoQuery(sQuery)

                                            sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Open', [EmailBody] = '" & Replace(sBody, "'", "''") & "', [EmailSub] = '" & sEmailSubject & "' where seq = " & _
                                               "(select top (1) seq  from " & p_sHoldingEntity & " ..[AB_EmailStatus] where draftkey = '" & sDraftKey & "' and DocType = 'PR' order by cast(Seq as integer) Desc)  and draftkey = '" & sDraftKey & "' and DocType = 'PR'"
                                            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Triggering to Originator " & sQuery, sFuncName)
                                            orset.DoQuery(sQuery)
                            ...
                            If pVal.ItemUID = "1" And (oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Or oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE) Then
                                ...
                                Try
                                    ...
                                    ElseIf p_sAstatus = "N" Then
                                        ...
                                        sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Closed' where Status = 'Pending'" & _
                                         " and draftkey = '" & sDraftKey & "' and DocType = '" & sDoctype & "'"
                                        If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Changing Status to Closed " & sQuery, sFuncName)
                                        orset.DoQuery(sQuery)

                                        sQuery = "update " & p_sHoldingEntity & " ..[AB_EmailStatus] set [Status] = 'Open', [EmailBody] = '" & Replace(sBody, "'", "''") & "', [EmailSub] = '" & sEmailSubject & "' where seq = " & _
                                           "(select top (1) seq  from " & p_sHoldingEntity & " ..[AB_EmailStatus] where draftkey = '" & sDraftKey & "' and DocType = '" & sDoctype & "' order by cast(Seq as integer) Desc)  and draftkey = '" & sDraftKey & "' and DocType = '" & sDoctype & "'"
                                        If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Triggering to Originator " & sQuery, sFuncName)
                                        orset.DoQuery(sQuery)
                            ...
                            If pVal.ItemUID = "1" And oForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
                                ...
                                Try
                                    ...
                                    If oForm.Items.Item("3").Specific.value = "I" Then
                                        ...
                                        SQL = "select DocEntry , U_BudName , U_Period ,U_Account , '' [U_OUCode] , U_BUCode , U_PrjCode , U_BudAmount, U_BalAmount  from " & p_sHoldingEntity & ".. [@AB_PROJECTBUDGET] T0 " & _
            "join [OBGS] T1 on T0.[U_BudName] = T1.[Name] where T1.[U_AB_ACTIVE] = 'Yes'"
...
CostCenterValidation:
                                        ...
                                        '---- Budget Validation  
                                        If Budget_Validation(oNewForm, sErrDesc) <> RTN_SUCCESS Then
                                            BubbleEvent = False
                                            Exit Sub
                                        End If
                        ...
                        If pVal.EventType = SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED Then
                            ...
                            If pVal.ItemUID = "1" And oForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE Then
                                Try
                                    ...
                                    sSQL = " select cast(char(39) + T0.U_Appr1 + char(39) + ',' + char(39) + T0.U_Appr2 + char(39) + ',' + char(39) + T0.U_Appr3 + char(39) as varchar) [User]  " & _
                                             " from [@AB_APPROVALMATRIX] T0 where T0.U_ApprGridCode = '" & sApprovalGridcode & "'"
                            ...
                            If Approval = True Then
                                ...
                                If p_oDTEmailAddress.Rows.Count > 0 Then
                                    ...
                                    For Each odr As DataRow In p_oDTEmailAddress.Rows
                                        ...
                                        icount += 1
                                        sBody = String.Empty
                                        If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Count " & icount, sFuncName)
