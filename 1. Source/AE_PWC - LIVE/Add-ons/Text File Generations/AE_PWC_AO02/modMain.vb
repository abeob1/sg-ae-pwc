...
Namespace AE_PWC_AO02
    Module modMain
        ...
        Public P_sJV_Debit As String = String.Empty
        Public P_sJV_Credit As String = String.Empty
        Public P_sNonJV_Credit As String = String.Empty
        Public P_sDEP_CA As String = String.Empty
        Public P_sDEP_FAA As String = String.Empty
        Public P_sDEP_JE As String = String.Empty
        ...
        Public oDT_TxtFileGeneration As DataTable
        Public dtTable As New DataTable
        Public iJEFormType As Integer = 0
        Public bJEflag As Boolean = False
        Public p_sCancel As String = String.Empty
        Public p_sSelectedFilepath As String = String.Empty
        Public p_oCostCentre As DataTable = Nothing
        Public p_oDistribution As DataTable = Nothing
        Public p_Summaryreport As String = String.Empty
        Public p_Dimensionrules As String = String.Empty
        Public p_bDimension As Boolean = False
        Public p_bCostcentre As Boolean = False
        ...
        Sub Main(ByVal args() As String)
            ...
            Try
                ...
                dtTable.Columns.Add("AcctCode", GetType(String))
                dtTable.Columns.Add("RefDate", GetType(String))
                dtTable.Columns.Add("OU Code", GetType(String))
                dtTable.Columns.Add("Entity", GetType(String))
                dtTable.Columns.Add("DC", GetType(String))
                dtTable.Columns.Add("Amount", GetType(Decimal))

                '' P_sDEP_JE = ConfigurationManager.AppSettings("Depreciation")

                'P_sJV_Debit = ConfigurationManager.AppSettings("JV_Debit")
                'P_sJV_Credit = ConfigurationManager.AppSettings("JV_Credit")
                'P_sNonJV_Credit = ConfigurationManager.AppSettings("NonJV_Credit")
