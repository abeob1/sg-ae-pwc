...
Namespace AE_PWC_AO02
    Module modLogging
        ...
        Public Function WriteToLogFile_Debug1(ByVal strErrText As String, ByVal strSourceName As String, Optional ByVal intCheckFileForDelete As Int16 = 1) As Long
            ...
            Try
                ...
                strSourceName = strTempString & strSourceName
                strErrText = "[" & Format(Now, "MM/dd/yyyy HH:mm:ss") & "]" & "[" & strSourceName & "] " & strErrText
                strFileName = System.Windows.Forms.Application.StartupPath & "\DT.log"
                strArchFileName = System.Windows.Forms.Application.StartupPath & "\DT" & Format(Now(), "yyMMddHHMMss") & ".log"
                ...
                oStreamWriter = File.AppendText(strFileName)
                oStreamWriter.WriteLine(strErrText)
                WriteToLogFile_Debug1 = RTN_SUCCESS
            Catch exc As Exception
                WriteToLogFile_Debug1 = RTN_ERROR
            Finally
                If Not IsNothing(oStreamWriter) Then
                    oStreamWriter.Flush()
                    oStreamWriter.Close()
