...
Module modCommon
    ...
    Public Function GetSystemIntializeInfo(ByRef oCompDef As CompanyDefault, ByRef oCompany As SAPbobsCOM.Company, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            oCompDef.sNote1 = String.Empty
            oCompDef.sNote2 = String.Empty
            oCompDef.sNote3 = String.Empty

            oCompDef.sNote1 = ConfigurationManager.AppSettings("Note1")
            oCompDef.sNote2 = ConfigurationManager.AppSettings("Note2")
            oCompDef.sNote3 = ConfigurationManager.AppSettings("Note3")
