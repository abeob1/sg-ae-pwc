...
Module modCommon
    ...
    Public Function GetSystemIntializeInfo(ByRef oCompDef As CompanyDefault, ByRef oCompany As SAPbobsCOM.Company, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            sSqlstr = "SELECT T0.[USER_CODE], T0.[U_NAME] FROM OUSR T0"
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("User Information  " & sSqlstr, sFuncName)
            orset.DoQuery(sSqlstr)
            p_oDTUserInformation = New DataTable
            p_oDTUserInformation = ConvertRecordset(orset)
        ...
        Try
            ...
            For imjs As Integer = 0 To oDocumentDT.Rows.Count - 1
                ...
                If rows.Count > 0 Then
                    ...
                    If (Math.Abs(Convert.ToDecimal(rows(0).Item("LineTotal"))) + (Math.Abs(Convert.ToDecimal(rows(0).Item("LineTotal"))) * dVarPercentage)) < Math.Abs(Convert.ToDecimal(oDocumentDT.Rows(imjs).Item("LineTotal").ToString)) _
                      Or ((Math.Abs(Convert.ToDecimal(rows(0).Item("LineTotal"))) + dVarAmount) < Math.Abs(Convert.ToDecimal(oDocumentDT.Rows(imjs).Item("LineTotal").ToString))) Then
        ...
        Try
            ...
            For imjs As Integer = 1 To oMatrix.VisualRowCount
                ...
                If sFlag = "True" Then
                    ...
                    If Not String.IsNullOrEmpty(oMatrix.Columns.Item("31").Cells.Item(imjs).Specific.String) Then  ' PROJECT CHECK
                        '' oRow = p_oDTPOMatrixs.Select("GLAccount = '" & oMatrix.Columns.Item("29").Cells.Item(imjs).Specific.String & "' and Project = '" & oMatrix.Columns.Item("2001").Cells.Item(imjs).Specific.String & "'")
                        p_oDTPOMatrixs.Rows.Add(imjs, oMatrix.Columns.Item("29").Cells.Item(imjs).Specific.String, Convert.ToDouble(sCurrencySplit(1)) _
                                         , oMatrix.Columns.Item("2002").Cells.Item(imjs).Specific.String, oMatrix.Columns.Item("2003").Cells.Item(imjs).Specific.String, oMatrix.Columns.Item("31").Cells.Item(imjs).Specific.String, "Prj", 0.0, "")
                        ''oRow = p_oDTPOMatrixs.Select("Project = '" & oMatrix.Columns.Item("31").Cells.Item(imjs).Specific.String & "'")
                        ''If oRow.Count > 0 Then
                        ''    oRow(0)("LineAmount") += Convert.ToDouble(sCurrencySplit(1))
                    ...
                    ElseIf Not String.IsNullOrEmpty(oMatrix.Columns.Item("U_AB_NONPROJECT").Cells.Item(imjs).Specific.String) Then  ' BU CHECK
                        '' AB_NONPROJECT
                        p_oDTPOMatrixs.Rows.Add(imjs, oMatrix.Columns.Item("29").Cells.Item(imjs).Specific.String, Convert.ToDouble(sCurrencySplit(1)) _
                                        , oMatrix.Columns.Item("2002").Cells.Item(imjs).Specific.String, oMatrix.Columns.Item("U_AB_NONPROJECT").Cells.Item(imjs).Specific.String, oMatrix.Columns.Item("31").Cells.Item(imjs).Specific.String, "BU", 0.0, "")
                        ''oRow = p_oDTPOMatrixs.Select("GLAccount = '" & oMatrix.Columns.Item("29").Cells.Item(imjs).Specific.String & "' and BU = '" & oMatrix.Columns.Item("U_AB_NONPROJECT").Cells.Item(imjs).Specific.String & "'")
                        ''If oRow.Count > 0 Then
                        ''    oRow(0)("LineAmount") += Convert.ToDouble(sCurrencySplit(1))
                    ...
                    Else
                        p_oDTPOMatrixs.Rows.Add(imjs, oMatrix.Columns.Item("29").Cells.Item(imjs).Specific.String, Convert.ToDouble(sCurrencySplit(1)) _
                                      , oMatrix.Columns.Item("2002").Cells.Item(imjs).Specific.String, oMatrix.Columns.Item("U_AB_NONPROJECT").Cells.Item(imjs).Specific.String, oMatrix.Columns.Item("31").Cells.Item(imjs).Specific.String, "O", 0.0, "")
    ...
    Public Function MatrixDataToDataTable(ByRef oForm As SAPbouiCOM.Form, _
                                     ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            MatrixDataToDataTable = RTN_SUCCESS
